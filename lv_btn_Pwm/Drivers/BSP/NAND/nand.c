...
uint8_t nand_init(void)
{
    ...
    g_nand_handle.Init.TCLRSetupTime = 5;                                  /* 设置TCLR(tCLR=CLE到RE的延时)=(TCLR+SET+2)*THCLK,THCLK=1/240M=4.1ns */
    g_nand_handle.Init.TARSetupTime = 5;                                   /* 设置TAR(tAR=ALE到RE的延时)=(TAR+SET+1)*THCLK,THCLK=1/240M=4.1ns */
    ...
    attspacetiming.SetupTime = 0;           /* 建立时间 */
    attspacetiming.WaitSetupTime = 0;       /* 等待时间 */
    attspacetiming.HoldSetupTime = 0;       /* 保持时间 */
    attspacetiming.HiZSetupTime = 0;        /* 高阻态时间 */
