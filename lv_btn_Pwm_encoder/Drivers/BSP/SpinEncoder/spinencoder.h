...
#define Z_INT_IRQHandler         EXTI15_10_IRQHandler
/* 函数声明 */
...
//extern	 uint8_t X_encode_Right ;                                  	/* 定时器3编码计数 	*/
//extern	 uint8_t X_encode_Left ;                                   	/* 定时器3编码计数 	*/
//extern	 uint8_t Y_encode_Right ;                             		/* 定时器4编码计数  	*/
//extern	 uint8_t Y_encode_Left ;                             		/* 定时器4编码计数  	*/
//extern	 uint8_t Z_encode_Right ;                             		/* 定时器5编码计数  	*/
//extern	 uint8_t Z_encode_Left ;                             		/* 定时器5编码计数  	*/
